...
const Contacts = () => {
  return (
    ...
    from-cyan-800 to-green-400 p-4 text-black">
        ...
        mx-auto h-full">
            ...
            <div className="flex justify-center items-center">
                ...
                method="POST" className="flex flex-col w-full md:w-1/2">
                    ...
                    border-2 rounded-md text-black focus:outline-none" 
                    />
                    ...
                    border-2 rounded-md text-black focus:outline-none"></textarea>

                    <button className="text-black bg-gradient-to-b from-blue-200 to-green-400 
